...
import {
  updateAfterEachLoginAction,
  watchForFetchTxTaskAction,
  watchForUpdateScriptTaskAction,
} from './updater';
...
function* mainSaga(): SagaGenerator<void, void> {
  ...
  yield fork(watchForUpdateScriptTaskAction);
  yield fork(watchForFetchTxTaskAction);
