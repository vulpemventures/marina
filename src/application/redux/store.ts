import { UPDATE_ASSETS, UPDATE_TAXI_ASSETS, UPDATE_TXS, UPDATE_UTXOS } from './actions/action-types';
import { createStore, applyMiddleware, Store } from 'redux';
import { alias, wrapStore } from 'webext-redux';
import marinaReducer from './reducers';
import { fetchAndSetTaxiAssets, updateAllAssetInfos, updateTxsHistory, updateUtxos } from '../backend';
