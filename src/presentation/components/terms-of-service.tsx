  ...
  return (
    <div className="h-25.75 overflow-y-scroll">
      ...
      <p className="font-regular my-8 text-sm text-left">
        By installing the Marina extension, you are agreeing to be bound by these terms of service,
        ...
        from using or accessing this software. The materials contained in this extension are
      ...
      <p className="font-regular my-8 text-sm text-left">
        ...
        be terminated by Marina at any time. Upon terminating your viewing of these materials or
      ...
      <p className="font-regular my-8 text-sm text-left">
        ...
        rights. Further, Marina does not warrant or make any representations concerning the
        accuracy, likely results, or reliability of the use of the materials on its extension or
      ...
      <p className="font-regular my-8 text-sm text-left">
        ...
        of the use or inability to use the materials on Marina's extension, even if Marina or a
        Marina authorized representative has been notified orally or in writing of the possibility
      ...
      <p className="font-regular my-8 text-sm text-left">
        Our Services provide a number of ways for you to secure your Wallet and help ensure you, and
        only you, are able to access and transact through your Wallet. These features include
        ...
        authentication GreenAddress has no way to recover them for you and you may permanently lose
      ...
      <p className="font-regular my-8 text-sm text-left">
        ...
        photographic errors. Marina does not warrant that any of the materials on its extension are
        accurate, complete or current. Marina may make changes to the materials contained on its
        extension at any time without notice. However Marina does not make any commitment to update
        the materials.
      </p>

      <h2 className="font-regular my-8 text-base text-left">6. Links</h2>
      <p className="font-regular my-8 text-sm text-left">
        Marina has not reviewed all of the sites linked to its extension and is not responsible for
        the contents of any such linked site. The inclusion of any link does not imply endorsement
        by Marina of the site. Use of any such linked extension is at the user's own risk.
      </p>
      ...
      <p className="font-regular my-8 text-sm text-left">
        ...
        using this extension you are agreeing to be bound by the then current version of these terms
        of service.
      </p>
