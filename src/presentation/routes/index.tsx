...
import EndOfFlow from '../../application/store/containers/end-of-flow.container';
import SeedReveal from '../../application/store/containers/seed-reveal.container';
import SeedConfirm from '../../application/store/containers/seed-confirm.container';
// Wallet
...
import SettingsShowMnemonic from '../../application/store/containers/settings-show-mnemonic.container';
