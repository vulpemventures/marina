...
class WasmModule<T = any> {
    ...
    static async fromBase64<T = any>(base64: string, imports: Record<string, any> = {}): Promise<WasmModule<T>> {
...
const secp256k1 = await WasmModule.fromBase64<TinySecp256k1Interface>(b64wasm as unknown as string, secp256k1imports);
const ecc = secp256k1.exports;

console.log(ecc.isPoint(Buffer.from('0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798', 'hex')));
